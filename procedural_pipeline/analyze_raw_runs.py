...
FIELD_TO_DISPLAY = {field: display for display, field in METRICS}  # enjoyment -> fun, ...
    ...
    for raw_file in raw_files:
        ...
        for run in runs:
            ...
            if isinstance(parsed, dict):
                ...
                for metric in ("enjoyment", "difficulty", "frustration", "novelty", "aesthetics"):
...
def save_outputs(output_dir: str, run_rows: list[dict], summary: dict) -> None:
    ...
    if run_rows:
        fieldnames = [
            ...
            "enjoyment", "difficulty", "frustration", "novelty", "aesthetics",
